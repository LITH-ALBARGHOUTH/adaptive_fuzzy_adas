...
class DemoConfig:
    ...
    ego_lane_visual_offset_m: float = 1.75
    lane_visual_scale: float = 2.0
    lane_departure_limit_m: float = 1.75
    road_lane_count: int = 2
    road_length_m: float = 1800.0
    road_width_margin_m: float = 2.0
    oncoming_spawn_distance_m: float = 170.0
    oncoming_clearance_distance_m: float = 26.0
    oncoming_critical_distance_m: float = 14.0
    overtake_trigger_distance_m: float = 26.0
    overtake_min_speed_advantage_mps: float = 1.2
    overtake_safe_oncoming_distance_m: float = 60.0
    overtake_return_gap_m: float = 11.0
    overtake_left_lane_target_m: float = -1.30
    uphill_ramp_start_m: float = 120.0
    uphill_ramp_end_m: float = 1050.0
    uphill_ramp_height_m: float = 18.0
